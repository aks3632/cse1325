...
public class Solver {
    public static void main(String[] args) {
        ...
        int     threads = 5;           // Use this many threads to search
        ...
        for(var file : polynomials.keySet()) {
            ...
            p.solve(min, max, threads, slices, precision); // Pg3 - P12 Requirements | y.solve(-100, 100, 1, 10000, 0.000001);
            System.out.println(file + ": " + p.toString() + " has " + p.roots().length + " roots\n  "
                             + Arrays.toString(p.roots()) + "\n"); // Pg3 - P12 Requirements | Print array with comma separators inside square brackets
        }
    }
}
